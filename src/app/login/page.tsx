      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-xl">
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-ce-border bg-white py-3 font-medium text-ce-text transition hover:bg-gray-50 disabled:opacity-50"
          >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-4 text-ce-text-muted">or</span>
            </div>
          </div>
