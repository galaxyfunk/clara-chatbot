...
## v1.0 Build Sessions
| Session | Focus | Steps | Day |
|---------|-------|-------|-----|
| 1 | Setup + DB + Auth + Types + All Lib Functions | 1–5 | Mon |
| 2 | All API Routes | 6–9 | Tue |
| 3 | All Dashboard UI | 10–14 | Wed–Thu |
| 4 | Widget + Landing + Deploy | 15–18 | Thu–Fri |
