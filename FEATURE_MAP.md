...
### LLM-Generated Suggestion Chips
- **Description:** Contextual follow-up questions generated by AI after each response with fallback chain
- **Page:** All chat interfaces
- **API Route:** `src/app/api/chat/route.ts` — included in streaming response
- **Components:** `src/components/chat/suggestion-chips.tsx`
- **Lib Modules:** `src/lib/chat/engine.ts` (generateFollowUpChips function)
- **DB Tables:** N/A (generated per-response)
- **Session:** v1.1-8
